	   ...
	   setResizable(false);
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='식혜';");
		...
		else if(e.getSource().equals(헬로파))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '헬로팬돌이(파랑)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='헬로팬돌이(파랑)';");
                    	st2.execute("insert into cart values('헬로팬돌이(파랑)','1000')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(헬로분))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '헬로팬돌이(분홍)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='헬로팬돌이(분홍)';");
                    	st2.execute("insert into cart values('헬로팬돌이(분홍)','1000')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(결명자))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '결명자';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='결명자';");
                    	st2.execute("insert into cart values('결명자','1500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(옥수수))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '옥수수수염차';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='옥수수수염차';");
                    	st2.execute("insert into cart values('옥수수수염차','1500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(바나나))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '바나나우유';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='바나나우유';");
                    	st2.execute("insert into cart values('바나나우유','1200')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
