...
public class Login extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent a) {
		...
		try{
		      ...
		      // System.out.println(result.getString(1)+"하하하하하하하하");
		       // 결과를 하나씩 출력한다.
		       while (result.next()){
		    	   if(a.getSource().equals(btn)){
		    		   ...
		    		   if(result.getString(1).equals(hakbun.getText())&&result.getString(2).equals(name.getText())){
		    				try{
		    					JOptionPane.showMessageDialog(null, "취소 횟수가 3회를 넘어 프로그램을 이용하지 못합니다", "ERROR_MESSAGE", JOptionPane.ERROR_MESSAGE);
		   						System.exit(1);  
		   						btn.setEnabled(true);
		   						Thread.sleep(300000);
		   						}catch(Exception e3){
