	  ...
	  c.add(menub); c.add(choob); c.add(boarb); c.add(cartb);
	   ...
	   setResizable(false);
		...
		{try {
            ...
            st.execute("use menu;"); 
            result = st.executeQuery("select name from allmenu where name = '고소미';");
            ...
            while (result.next()){
               ...
               int reply = JOptionPane.showConfirmDialog(this, str);
                if(reply == JOptionPane.YES_OPTION){
                	...
                	st2.execute("update allmenu set product=product+1 where name='고소미';");
                	st2.execute("insert into cart values('고소미','1500')");
                }
            }
		} catch (Exception e1) {
			e1.printStackTrace();
		...
		else if(e.getSource().equals(포테토칩))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '씨리얼';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='씨리얼';");
                    	st2.execute("insert into cart values('씨리얼','1000')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(바나나킥))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '빼빼로';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='빼빼로';");
                    	st2.execute("insert into cart values('빼빼로','1200')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(뽀또))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '알새우칩';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='알새우칩';");
                    	st2.execute("insert into cart values('알새우칩','1300')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(예감))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '꼬깔콘';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='꼬깔콘';");
                    	st2.execute("insert into cart values('꼬깔콘','1500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(포스틱))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '허니버터칩';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='허니버터칩';");
                    	st2.execute("insert into cart values('허니버터칩','1500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(매운새우깡))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '땅콩샌드';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='땅콩샌드';");
                    	st2.execute("insert into cart values('땅콩샌드','1000')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(초코칩쿠키))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '버터링';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='버터링';");
                    	st2.execute("insert into cart values('버터링','1400')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
