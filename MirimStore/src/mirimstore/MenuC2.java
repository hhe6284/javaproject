	   ...
	   setResizable(false);
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource().equals(토레타))
			{
				try {
	                ...
	                st.execute("use menu;"); 
	                result = st.executeQuery("select name from allmenu where name = '피크닉(청포도)';");
	                ...
	                while (result.next()){
	                   ...
	                   int reply = JOptionPane.showConfirmDialog(this, str);
	                    if(reply == JOptionPane.YES_OPTION){
	                    	...
	                    	st2.execute("update allmenu set product=product+1 where name='피크닉(청포도)';");
	                    	st2.execute("insert into cart values('피크닉(청포도)','500')");
	                    }
	                }
				} catch (Exception e1) {
					e1.printStackTrace();
			...
			else if (e.getSource().equals(두유))
		{
				try {
	                ...
	                st = con.createStatement();
	                st.execute("use menu;"); 
	                result = st.executeQuery("select name from allmenu where name = '피크닉(사과)';");
	                ...
	                while (result.next()){
	                   ...
	                   int reply = JOptionPane.showConfirmDialog(this, str);
	                    if(reply == JOptionPane.YES_OPTION){
	                    	 java.sql.Statement st2 = null;
	                         st2 = con.createStatement();
	                    	st2.execute("update allmenu set product=product+1 where name='피크닉(사과)';");
	                    	st2.execute("insert into cart values('피크닉(사과)','500')");
	                    }
	                }
				} catch (Exception e1) {
					e1.printStackTrace();
		...
		else if(e.getSource().equals(식혜))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '허쉬';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='허쉬';");
                    	st2.execute("insert into cart values('허쉬','1000')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(헬로파))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '드링크(청포도)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='드링크(청포도)';");
                    	st2.execute("insert into cart values('드링크(청포도)','500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(헬로분))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '드링크(오렌지)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='드링크(오렌지)';");
                    	st2.execute("insert into cart values('드링크(오렌지)','500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(결명자))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '드링크(사과)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='드링크(사과)';");
                    	st2.execute("insert into cart values('드링크(사과)','500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(옥수수))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '델몬트(망고)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='델몬트(망고)';");
                    	st2.execute("insert into cart values('델몬트(망고)','1200')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(바나나))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '델몬트(오렌지)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='델몬트(오렌지)';");
                    	st2.execute("insert into cart values('델몬트(오렌지)','500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
