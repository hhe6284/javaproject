	...
	public MenuFrameC3()
	  {
	   ...
	   토레타 = new JButton(new ImageIcon("img/u-17.png"));
	   두유 = new JButton(new ImageIcon("img/u-18.png"));
	   식혜 = new JButton(new ImageIcon("img/u-19.png"));
	   헬로파 = new JButton(new ImageIcon("img/u-20.png"));
	   헬로분 = new JButton(new ImageIcon("img/u-21.png"));
	   결명자 = new JButton(new ImageIcon("img/u-22.png"));
	   옥수수 = new JButton(new ImageIcon("img/u-23.png"));
	   바나나 = new JButton(new ImageIcon("img/u-24.png"));
	   ...
	   setResizable(false);
		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource().equals(토레타))
			{
				try {
	                ...
	                st.execute("use menu;"); 
	                result = st.executeQuery("select name from allmenu where name = '델몬트(포도)';");
	                ...
	                while (result.next()){
	                   ...
	                   int reply = JOptionPane.showConfirmDialog(this, str);
	                    if(reply == JOptionPane.YES_OPTION){
	                    	...
	                    	st2.execute("update allmenu set product=product+1 where name='델몬트(포도)';");
	                    	st2.execute("insert into cart values('델몬트(포도)','500')");
	                    }
	                }
				} catch (Exception e1) {
					e1.printStackTrace();
			...
			else if (e.getSource().equals(두유))
		{
				try {
	                ...
	                st = con.createStatement();
	                st.execute("use menu;"); 
	                result = st.executeQuery("select name from allmenu where name = '미닛메이드(사과)';");
	                ...
	                while (result.next()){
	                   ...
	                   int reply = JOptionPane.showConfirmDialog(this, str);
	                    if(reply == JOptionPane.YES_OPTION){
	                    	 java.sql.Statement st2 = null;
	                         st2 = con.createStatement();
	                    	st2.execute("update allmenu set product=product+1 where name='미닛메이드(사과)';");
	                    	st2.execute("insert into cart values('미닛메이드(사과)','500')");
	                    }
	                }
				} catch (Exception e1) {
					e1.printStackTrace();
		...
		else if(e.getSource().equals(식혜))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '미닛메이드(오렌지)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='미닛메이드(오렌지)';");
                    	st2.execute("insert into cart values('미닛메이드(오렌지)','500')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(헬로파))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '코코팜(화이트)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='코코팜(화이트)';");
                    	st2.execute("insert into cart values('코코팜(화이트)','700')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(헬로분))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '코코팜(망고)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='코코팜(망고)';");
                    	st2.execute("insert into cart values('코코팜(망고)','700')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(결명자))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '코코팜(피치)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='코코팜(피치)';");
                    	st2.execute("insert into cart values('코코팜(피치)','700')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(옥수수))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '서울우유(초코)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='서울우유(초코)';");
                    	st2.execute("insert into cart values('서울우유(초코)','800')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
		...
		else if(e.getSource().equals(바나나))
		{
			try {
                ...
                st = con.createStatement();
                st.execute("use menu;"); 
                result = st.executeQuery("select name from allmenu where name = '서울우유(일반)';");
                ...
                while (result.next()){
                   ...
                   int reply = JOptionPane.showConfirmDialog(this, str);
                    if(reply == JOptionPane.YES_OPTION){
                    	 java.sql.Statement st2 = null;
                         st2 = con.createStatement();
                    	st2.execute("update allmenu set product=product+1 where name='서울우유(일반)';");
                    	st2.execute("insert into cart values('서울우유(일반)','800')");
                    }
                }
			} catch (Exception e1) {
				e1.printStackTrace();
